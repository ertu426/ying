  ...
  shortcuts: [
    {
      ...
      "page-container":
        "bg-gray-100 flex dark:!bg-gray-800/80 dark:text-gray-200 bg-white",
      "page-main":
        "w-full max-w-full bg-white shadow-lg mx-auto my-0 overflow-hidden p-8 min-h-fit dark:bg-zinc-900 sm:max-w-full sm:my-0 sm:p-8 md:max-w-2xl md:my-12 md:p-8 md:rounded-lg lg:max-w-3xl lg:my-16 lg:p-12 lg:rounded-lg",
      ...
      "section-header":
        "mb-5 !text-sm text-gray-400 !font-bold dark:text-gray-300",
